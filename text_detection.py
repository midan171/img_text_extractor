...
def text_localization(img_source):

	# construct the argument parser and parse the arguments
	ap = argparse.ArgumentParser()
	ap.add_argument("-image", "--image", type=str,
					help="path to input image")
	ap.add_argument("--east", "-east frozen_east_text_detection.pb", type=str,
	...
	for (startX, startY, endX, endY) in boxes:
		...
		#cut text regions to an img list
